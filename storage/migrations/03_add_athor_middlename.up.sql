...
INSERT INTO author (id, firstname, middlename, lastname) VALUES ('3e1dfc06-dcf6-41fc-b3cc-7c0563fdfab4', 'John','dev', 'Doe') ON CONFLICT DO NOTHING;
INSERT INTO author (id, firstname,middlename, lastname) VALUES ('24000e82-9c48-4297-a442-ecd1ad55791a','yorqin','dev','Baqoyev') ON CONFLICT DO NOTHING;
